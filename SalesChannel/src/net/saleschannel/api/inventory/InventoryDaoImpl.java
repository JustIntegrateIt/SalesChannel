...
public class InventoryDaoImpl implements InventoryDao {
	...
	public InventoryJsonModel getInventoryById(String inventoryId) {
		...
		try {
			...
			query.addCriteria(Criteria.where("_class").is("net.saleschannel.api.inventory.InventoryJsonModel")
	...
	public ShelfJsonModel getShelfById(String shelfId) {
		...
		try {
			Query query = new Query();
			query.addCriteria(Criteria.where("_class").is("net.saleschannel.api.inventory.ShelfJsonModel")
					.and("_id").is(shelfId));
	...
	public BinJsonModel getBinById(String binId) {
		...
		try {
			Query query = new Query();
			query.addCriteria(Criteria.where("_class").is("net.saleschannel.api.inventory.BinJsonModel")
					.and("_id").is(binId));
	...
	public PositionJsonModel getPositionById(String positionId) {
		...
		try {
			Query query = new Query();
			query.addCriteria(Criteria.where("_class").is("net.saleschannel.api.inventory.PositionJsonModel")
