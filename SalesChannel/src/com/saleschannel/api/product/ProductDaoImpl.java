...
public class ProductDaoImpl implements ProductDao {
	...
	public ProductJsonModel checkProductExist(String skuId, String customerId) {
		...
		try {
			...
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductJsonModel")
	...
	public AttributeJsonModel checkAttributeExist(String attributeName) {
		...
		try {
			Query query = new Query();
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.AttributeJsonModel")
	...
	public ProductAttributesJsonModel checkProductAttributeExist(String productId, String skuId) {
		...
		try {
			Query query = new Query();
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductAttributesJsonModel")
	...
	public ProductAttributesJsonModel getProductAttributeById(String productAttributeId) {
		...
		try {
			...
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductAttributesJsonModel")
					.and("_id").is(productAttributeId));
			productAttributesJsonModel = this.mongoOps.findOne(query, 
					ProductAttributesJsonModel.class, SalesChannelConstants.SC_PRODUCT_ATTRIBUTE);
		} catch(Exception e) {
	...
	public boolean deleteProductAttributeByProductId(String productId) {
		...
		try {
			...
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductAttributesJsonModel")
					.and("productId").is(productId));
			this.mongoOps.remove(query, SalesChannelConstants.SC_PRODUCT_ATTRIBUTE);			
			status = true;
		} catch(Exception e) {
	...
	public boolean deleteProductAttributeCombination(String productAttributeCombinationId) {
		...
		try {
			Query query = new Query();
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductAttributeCombinationJsonModel")
	...
	public boolean deleteProductAttributeCombinationByProductAttributId(
		...
		try {
			...
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductAttributeCombinationJsonModel")
					.and("productAttributeId").is(productAttributId));
			this.mongoOps.remove(query, SalesChannelConstants.SC_PRODUCT_ATTRIBUTE_COMBINATION);
			status = true;
		} catch(Exception e) {
	...
	public boolean deleteProductAccessoriesById(String productAccessoriesId) {
		...
		try {
			Query query = new Query();
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductAccessoriesJsonModel")
					.and("_id").is(productAccessoriesId));
	...
	public boolean deleteProductAccessoriesByProductId(String productId) {
		...
		try {
			...
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductAccessoriesJsonModel")
					.and("productId").is(productId));
			this.mongoOps.remove(query, SalesChannelConstants.SC_PRODUCT_ACCESSORIES);
			status = true;
		} catch(Exception e) {
	...
	public boolean deleteImageById(String productImageId) {
		...
		try {
			Query query = new Query();
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductImageJsonModel")
					.and("_id").is(productImageId));
	...
	public boolean deleteProductImageByProductId(String productId) {
		...
		try {
			...
			query.addCriteria(Criteria.where("_class").is("com.saleschannel.api.product.ProductImageJsonModel")
					.and("productId").is(productId));
			this.mongoOps.remove(query, SalesChannelConstants.SC_PRODUCT_IMAGE);
			status = true;
		} catch(Exception e) {
