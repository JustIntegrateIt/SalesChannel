...
public interface AmazonProductManagerService {
	...
	public List<GetCompetitivePricingForSKUResponse> getCompetitivePricingForSKUAsync(String sellerId, String mwsAuthToken
			, String marketplaceId, List<String> sellerSKU);
	
	public GetCompetitivePricingForSKUResponse getCompetitivePricingForSKU(String sellerId, String mwsAuthToken
			, String marketplaceId, List<String> sellerSKU);
    ...
    public GetProductCategoriesForASINResponse getProductCategoriesForASIN(String sellerId, String mwsAuthToken
    		, String marketplaceId, String asin);
    ...
    public GetProductCategoriesForSKUResponse getProductCategoriesForSKU(String sellerId, String mwsAuthToken
    		, String marketplaceId,	String sellerSKU);
