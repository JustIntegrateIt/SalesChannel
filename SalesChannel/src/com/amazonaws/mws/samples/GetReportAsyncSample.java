...
public class GetReportAsyncSample {
     ...
     * @param args unused
     */
    public List<GetReportResponse> getReportAsync(String merchantId, String sellerDevAuthToken) {

    	List<GetReportResponse> getReportResponse = null;
    	try {
	        /************************************************************************
	        ...
	        OutputStream reportTwo = new FileOutputStream( "report-2.xml" );
	        ...
	        getReportResponse = invokeGetReport(service, requests);
    	} catch(Exception e) {
    		e.printStackTrace();
    	}
     ...
     */
    public static List<GetReportResponse> invokeGetReport(MarketplaceWebService service, List<GetReportRequest> requests) {
        ...
        if(responses != null && responses.size() > 0) {
        	getReportResponseList = new ArrayList<GetReportResponse>();
        	for (Future<GetReportResponse> future : responses) {
                ...
                try {
                    ...
                    System.out.println();
                    getReportResponseList.add(response); 
                } catch (Exception e) {
