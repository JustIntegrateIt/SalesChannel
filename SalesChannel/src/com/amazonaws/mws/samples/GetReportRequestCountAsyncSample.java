...
public class GetReportRequestCountAsyncSample {
    ...
    public List<GetReportRequestCountResponse> getReportRequestCountAsync(String merchantId
        ...
        getReportRequestCountResponseList = invokeGetReportRequestCount(service, requests);
     ...
     */
    public static List<GetReportRequestCountResponse> invokeGetReportRequestCount(MarketplaceWebService service, List<GetReportRequestCountRequest> requests) {
    	List<GetReportRequestCountResponse> getReportRequestCountResponseList = null;
        ...
        if(responses != null && responses.size() > 0) {
        	getReportRequestCountResponseList = new ArrayList<GetReportRequestCountResponse>();
            for (Future<GetReportRequestCountResponse> future : responses) {
                ...
                try {
                    ...
                    System.out.println();
                    getReportRequestCountResponseList.add(response);
                } catch (Exception e) {
