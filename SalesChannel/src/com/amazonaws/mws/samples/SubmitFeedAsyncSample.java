...
public class SubmitFeedAsyncSample {
    ...
    public List<SubmitFeedResponse> submitFeedAsync(List<SubmitFeedRequest> requests) {
    	...
    	try {
            ...
            requests = new ArrayList<SubmitFeedRequest>();
            requests.add(requestOne);
            requests.add(requestTwo);

            submitFeedResponseList = invokeSubmitFeed(service, requests);
    	} catch(Exception e) {
    		e.printStackTrace();
    	}
     ...
     */
    public static List<SubmitFeedResponse> invokeSubmitFeed(MarketplaceWebService service, List<SubmitFeedRequest> requests) {
    	List<SubmitFeedResponse> submitFeedResponseList = null;
        ...
        if(responses != null && responses.size() > 0) {
        	submitFeedResponseList = new ArrayList<SubmitFeedResponse>();
        	for (Future<SubmitFeedResponse> future : responses) {
                ...
                try {
                    ...
                    System.out.println();
                    submitFeedResponseList.add(response);
                } catch (Exception e) {
