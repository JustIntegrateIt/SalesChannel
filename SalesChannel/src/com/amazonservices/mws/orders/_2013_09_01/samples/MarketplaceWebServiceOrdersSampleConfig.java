...
public class MarketplaceWebServiceOrdersSampleConfig {
    ...
    private static final String accessKey = "AKIAIC2MSCXCVWE3BLJQ";

    /** Developer AWS secret key. */
    private static final String secretKey = "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";

    /** The client application name. */
    private static final String appName = "JustIntegrate IT";

    /** The client application version. */
    private static final String appVersion = "2016-01-01";

    /**
     * The endpoint for region service and version.
     * ex: serviceURL = MWSEndpoint.NA_PROD.toString();
     */
    private static final String serviceURL = MWSEndpoint.IN_PROD.toString();
