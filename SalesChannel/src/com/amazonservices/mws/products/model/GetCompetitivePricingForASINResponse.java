...
public class GetCompetitivePricingForASINResponse extends AbstractMwsObject implements MWSResponse {
    ...
    public boolean isSetGetCompetitivePricingForASINResult() {
        return getCompetitivePricingForASINResult != null && !getCompetitivePricingForASINResult.isEmpty();
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        getCompetitivePricingForASINResult = r.readList("GetCompetitivePricingForASINResult", GetCompetitivePricingForASINResult.class);
    ...
    public void writeFragmentTo(MwsWriter w) {
        w.writeList("GetCompetitivePricingForASINResult", getCompetitivePricingForASINResult);
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetCompetitivePricingForASINResponse",this);
    }

    /** Value constructor. */
    public GetCompetitivePricingForASINResponse(List<GetCompetitivePricingForASINResult> getCompetitivePricingForASINResult,ResponseMetadata responseMetadata) {
        this.getCompetitivePricingForASINResult = getCompetitivePricingForASINResult;
        this.responseMetadata = responseMetadata;
    }    
