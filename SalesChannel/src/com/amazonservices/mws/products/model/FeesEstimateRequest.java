...
@XmlType(name="FeesEstimateRequest", propOrder={
    "marketplaceId",
    "idType",
    "idValue",
    "isAmazonFulfilled",
...
public class FeesEstimateRequest extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "FeesEstimateRequest",this);
    }

    /** Value constructor. */
    public FeesEstimateRequest(String marketplaceId,String idType,String idValue,Boolean isAmazonFulfilled,PriceToEstimateFees priceToEstimateFees,String identifier) {
        this.marketplaceId = marketplaceId;
        this.idType = idType;
        this.idValue = idValue;
        this.isAmazonFulfilled = isAmazonFulfilled;
