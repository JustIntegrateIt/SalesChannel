...
/**
 * GetMyPriceForSKUResponse complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="GetMyPriceForSKUResponse"&gt;
 *    &lt;complexContent&gt;
 *       &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *          &lt;sequence&gt;
 *             &lt;element name="GetMyPriceForSKUResult" type="{http://mws.amazonservices.com/schema/Products/2011-10-01}GetMyPriceForSKUResult" maxOccurs="unbounded"/&gt;
...
@XmlType(name="GetMyPriceForSKUResponse", propOrder={
    "getMyPriceForSKUResult",
    "responseMetadata"
})
@XmlRootElement(name = "GetMyPriceForSKUResponse")
public class GetMyPriceForSKUResponse extends AbstractMwsObject implements MWSResponse {

    @XmlElement(name="GetMyPriceForSKUResult")
    private List<GetMyPriceForSKUResult> getMyPriceForSKUResult;
    ...
    /**
     * Get the value of GetMyPriceForSKUResult.
     *
     * @return The value of GetMyPriceForSKUResult.
     */
    ...
    /**
     * Set the value of GetMyPriceForSKUResult.
     *
    ...
    public boolean isSetGetMyPriceForSKUResult() {
        return getMyPriceForSKUResult != null && !getMyPriceForSKUResult.isEmpty();
    }
    ...
    public GetMyPriceForSKUResponse withGetMyPriceForSKUResult(GetMyPriceForSKUResult... values) {
        List<GetMyPriceForSKUResult> list = getGetMyPriceForSKUResult();
    ...
    public void readFragmentFrom(MwsReader r) {
        getMyPriceForSKUResult = r.readList("GetMyPriceForSKUResult", GetMyPriceForSKUResult.class);
    ...
    public void writeFragmentTo(MwsWriter w) {
        w.writeList("GetMyPriceForSKUResult", getMyPriceForSKUResult);
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetMyPriceForSKUResponse",this);
    }

    /** Value constructor. */
    public GetMyPriceForSKUResponse(List<GetMyPriceForSKUResult> getMyPriceForSKUResult,ResponseMetadata responseMetadata) {
        this.getMyPriceForSKUResult = getMyPriceForSKUResult;
        this.responseMetadata = responseMetadata;
    }    
