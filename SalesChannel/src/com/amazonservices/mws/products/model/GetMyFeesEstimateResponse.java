...
public class GetMyFeesEstimateResponse extends AbstractMwsObject implements MWSResponse {
     ...
     */
    public void setGetMyFeesEstimateResult(GetMyFeesEstimateResult getMyFeesEstimateResult) {
    ...
    public void readFragmentFrom(MwsReader r) {
        getMyFeesEstimateResult = r.read("GetMyFeesEstimateResult", GetMyFeesEstimateResult.class);
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetMyFeesEstimateResponse",this);
    }

    /** Value constructor. */
    public GetMyFeesEstimateResponse(GetMyFeesEstimateResult getMyFeesEstimateResult,ResponseMetadata responseMetadata) {
        this.getMyFeesEstimateResult = getMyFeesEstimateResult;
        this.responseMetadata = responseMetadata;
    }    
