...
/**
 * GetMatchingProductRequest complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="GetMatchingProductRequest"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="GetMatchingProductRequest", propOrder={
    "sellerId",
    "mwsAuthToken",
    "marketplaceId",
    "asinList"
})
@XmlRootElement(name = "GetMatchingProductRequest")
public class GetMatchingProductRequest extends AbstractMwsObject {
     ...
     */
    public GetMatchingProductRequest withSellerId(String sellerId) {
        this.sellerId = sellerId;
        return this;
    }
     ...
     * @return This instance.
     */
    public GetMatchingProductRequest withMWSAuthToken(String mwsAuthToken) {
        this.mwsAuthToken = mwsAuthToken;
        return this;
    }
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetMatchingProductRequest",this);
    }

    /** Value constructor. */
    public GetMatchingProductRequest(String sellerId,String mwsAuthToken,String marketplaceId,ASINListType asinList) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.marketplaceId = marketplaceId;
        this.asinList = asinList;
    ...
    public GetMatchingProductRequest(String sellerId,String marketplaceId,ASINListType asinList) {
        this.sellerId = sellerId;
        this.marketplaceId = marketplaceId;
        this.asinList = asinList;
    }
