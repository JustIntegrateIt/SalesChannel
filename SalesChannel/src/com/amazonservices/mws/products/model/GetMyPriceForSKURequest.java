...
/**
 * GetMyPriceForSKURequest complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="GetMyPriceForSKURequest"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="GetMyPriceForSKURequest", propOrder={
    "sellerId",
    "mwsAuthToken",
    "marketplaceId",
    "sellerSKUList"
})
@XmlRootElement(name = "GetMyPriceForSKURequest")
public class GetMyPriceForSKURequest extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetMyPriceForSKURequest",this);
    }

    /** Value constructor. */
    public GetMyPriceForSKURequest(String sellerId,String mwsAuthToken,String marketplaceId,SellerSKUListType sellerSKUList) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.marketplaceId = marketplaceId;
        this.sellerSKUList = sellerSKUList;
    ...
    public GetMyPriceForSKURequest(String sellerId,String marketplaceId,SellerSKUListType sellerSKUList) {
        this.sellerId = sellerId;
        this.marketplaceId = marketplaceId;
        this.sellerSKUList = sellerSKUList;
    }
    ...
    /** Default constructor. */
    public GetMyPriceForSKURequest() {
        super();
    }
