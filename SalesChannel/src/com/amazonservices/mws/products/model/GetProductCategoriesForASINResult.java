...
@XmlType(name="GetProductCategoriesForASINResult", propOrder={
    "self"
})
@XmlRootElement(name = "GetProductCategoriesForASINResult")
public class GetProductCategoriesForASINResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetProductCategoriesForASINResult",this);
    }
