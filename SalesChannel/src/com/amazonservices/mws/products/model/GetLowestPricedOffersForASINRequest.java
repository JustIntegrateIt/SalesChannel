...
@XmlType(name="GetLowestPricedOffersForASINRequest", propOrder={
    "sellerId",
    "mwsAuthToken",
    "marketplaceId",
    "asin",
...
public class GetLowestPricedOffersForASINRequest extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetLowestPricedOffersForASINRequest",this);
    }

    /** Value constructor. */
    public GetLowestPricedOffersForASINRequest(String sellerId,String mwsAuthToken,String marketplaceId,String asin,String itemCondition) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.marketplaceId = marketplaceId;
        this.asin = asin;
    ...
    public GetLowestPricedOffersForASINRequest(String sellerId,String marketplaceId,String asin,String itemCondition) {
        this.sellerId = sellerId;
        this.marketplaceId = marketplaceId;
        this.asin = asin;
        this.itemCondition = itemCondition;
