...
public class GetLowestOfferListingsForASINRequest extends AbstractMwsObject {
    ...
    /** Value constructor. */
    public GetLowestOfferListingsForASINRequest(String sellerId,String mwsAuthToken,String marketplaceId,ASINListType asinList,String itemCondition,Boolean excludeMe) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.marketplaceId = marketplaceId;
        this.asinList = asinList;
    ...
    public GetLowestOfferListingsForASINRequest(String sellerId,String marketplaceId,ASINListType asinList,String itemCondition,Boolean excludeMe) {
        this.sellerId = sellerId;
        this.marketplaceId = marketplaceId;
        this.asinList = asinList;
        this.itemCondition = itemCondition;
