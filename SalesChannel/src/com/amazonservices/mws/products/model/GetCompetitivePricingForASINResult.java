 ...
 *******************************************************************************
 * Get Competitive Pricing For ASIN Result
...
/**
 * GetCompetitivePricingForASINResult complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="GetCompetitivePricingForASINResult"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="GetCompetitivePricingForASINResult", propOrder={
    "product",
    "error"
})
@XmlRootElement(name = "GetCompetitivePricingForASINResult")
public class GetCompetitivePricingForASINResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetCompetitivePricingForASINResult",this);
    }

    /** Value constructor. */
    public GetCompetitivePricingForASINResult(Product product,Error error,String asin,String status) {
        this.product = product;
        this.error = error;
        this.asin = asin;
        this.status = status;
