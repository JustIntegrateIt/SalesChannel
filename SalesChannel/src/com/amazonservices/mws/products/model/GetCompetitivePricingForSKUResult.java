...
/**
 * GetCompetitivePricingForSKUResult complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="GetCompetitivePricingForSKUResult"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="GetCompetitivePricingForSKUResult", propOrder={
    "product",
    "error"
})
@XmlRootElement(name = "GetCompetitivePricingForSKUResult")
public class GetCompetitivePricingForSKUResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "GetCompetitivePricingForSKUResult",this);
    }

    /** Value constructor. */
    public GetCompetitivePricingForSKUResult(Product product,Error error,String sellerSKU,String status) {
        this.product = product;
        this.error = error;
        this.sellerSKU = sellerSKU;
        this.status = status;
    ...
    /** Default constructor. */
    public GetCompetitivePricingForSKUResult() {
        super();
    }
