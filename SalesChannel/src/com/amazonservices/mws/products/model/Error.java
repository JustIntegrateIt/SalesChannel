...
public class Error extends AbstractMwsObject {
     ...
     *            The new value to set.
     */
    public void setDetail(Error.Detail detail) {
        this.detail = detail;
    }
     ...
     * @return This instance.
     */
    public Error withDetail(Error.Detail detail) {
        this.detail = detail;
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        detail = r.read("Detail", Error.Detail.class);
    }
