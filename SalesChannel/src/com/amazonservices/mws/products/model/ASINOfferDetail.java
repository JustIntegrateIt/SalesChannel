...
/**
 * ASINOfferDetail complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="ASINOfferDetail"&gt;
 *    &lt;complexContent&gt;
...
@XmlType(name="ASINOfferDetail", propOrder={
    "subCondition",
...
@XmlRootElement(name = "ASINOfferDetail")
public class ASINOfferDetail extends AbstractMwsObject {
     ...
     */
    public ASINOfferDetail withSubCondition(String subCondition) {
        this.subCondition = subCondition;
        return this;
    }
     ...
     * @return This instance.
     */
    public ASINOfferDetail withSellerFeedbackRating(SellerFeedbackType sellerFeedbackRating) {
        this.sellerFeedbackRating = sellerFeedbackRating;
        return this;
    }
     ...
     * @return This instance.
     */
    public ASINOfferDetail withListingPrice(MoneyType listingPrice) {
        this.listingPrice = listingPrice;
        return this;
    }
     ...
     * @return This instance.
     */
    public ASINOfferDetail withPoints(Points points) {
        this.points = points;
        return this;
    }
     ...
     * @return This instance.
     */
    public ASINOfferDetail withShipping(MoneyType shipping) {
        this.shipping = shipping;
        return this;
    }
     ...
     * @return This instance.
     */
    public ASINOfferDetail withIsFulfilledByAmazon(boolean isFulfilledByAmazon) {
        this.isFulfilledByAmazon = isFulfilledByAmazon;
        return this;
    }
     ...
     * @return This instance.
     */
    public ASINOfferDetail withIsBuyBoxWinner(Boolean isBuyBoxWinner) {
        this.isBuyBoxWinner = isBuyBoxWinner;
        return this;
    }
     ...
     * @return This instance.
     */
    public ASINOfferDetail withIsFeaturedMerchant(Boolean isFeaturedMerchant) {
        this.isFeaturedMerchant = isFeaturedMerchant;
        return this;
    }
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Products/2011-10-01", "ASINOfferDetail",this);
    }

    /** Value constructor. */
    public ASINOfferDetail(String subCondition,SellerFeedbackType sellerFeedbackRating,DetailedShippingTimeType shippingTime,MoneyType listingPrice,Points points,MoneyType shipping,ShipsFromType shipsFrom,boolean isFulfilledByAmazon,Boolean isBuyBoxWinner,Boolean isFeaturedMerchant) {
        this.subCondition = subCondition;
        this.sellerFeedbackRating = sellerFeedbackRating;
        this.shippingTime = shippingTime;
        this.listingPrice = listingPrice;
