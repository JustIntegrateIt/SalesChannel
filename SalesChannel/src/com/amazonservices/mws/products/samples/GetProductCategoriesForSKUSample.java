...
/** Sample call for GetProductCategoriesForSKU. */
public class GetProductCategoriesForSKUSample {
     ...
     * @return The response.
     */
    public static GetProductCategoriesForSKUResponse invokeGetProductCategoriesForSKU(
            MarketplaceWebServiceProducts client, 
            GetProductCategoriesForSKURequest request) {
        try {
            // Call the service.
            GetProductCategoriesForSKUResponse response = client.getProductCategoriesForSKU(request);
