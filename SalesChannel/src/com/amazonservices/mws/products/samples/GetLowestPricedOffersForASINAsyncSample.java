...
/** Sample async call for GetLowestPricedOffersForASIN. */
public class GetLowestPricedOffersForASINAsyncSample {
     ...
     * @return The response.
     */
    public static List<Object> invokeGetLowestPricedOffersForASIN(
            MarketplaceWebServiceProductsAsync client, 
            List<GetLowestPricedOffersForASINRequest> requestList) {
        // Call the service async.
        List<Future<GetLowestPricedOffersForASINResponse>> futureList = 
            new ArrayList<Future<GetLowestPricedOffersForASINResponse>>();
        for (GetLowestPricedOffersForASINRequest request : requestList) {
            Future<GetLowestPricedOffersForASINResponse> future = 
                client.getLowestPricedOffersForASINAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<GetLowestPricedOffersForASINResponse> future : futureList) {
            Object xresponse;
            try {
                GetLowestPricedOffersForASINResponse response = future.get();
