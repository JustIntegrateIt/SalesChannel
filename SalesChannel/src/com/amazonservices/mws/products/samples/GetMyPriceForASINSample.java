...
public class GetMyPriceForASINSample {
     ...
     * @return The response.
     */
    public static GetMyPriceForASINResponse invokeGetMyPriceForASIN(
    ...
    public GetMyPriceForASINResponse getMyPriceForASIN(String sellerId, String mwsAuthToken
        ...
        // Make the call.
        getMyPriceForASINResponse = GetMyPriceForASINSample.invokeGetMyPriceForASIN(client, request);
